...
@Module({
  imports: [IdentityModule, EnquiryModule, QuotationModule, ItineraryModule],
  controllers: [DocumentController],
  providers: [
    { provide: DOCUMENT_RENDERER, useClass: HtmlDocumentRenderer },
    {
      provide: DocumentService,
      inject: [DOCUMENT_RENDERER, QuotationService, EnquiryService, OrgService, ItineraryService],
      useFactory: (
      ...
      ) => new DocumentService({ renderer, quotation, enquiries, orgs, itineraries }),
    },
  ],
